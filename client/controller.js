...
var channelName = "group2channel";
module.exports = (function() {
return{
	
	request_loc: function(req, res){
		console.log("submit recording of a tuna catch: ");
		console.log(req.params);
		var array = req.params.loc.split("-");
		console.log(array);
		...
		Fabric_Client.newDefaultKeyValueStore({ path: store_path
		    ...
		    const request = {
		        ...
		        chaincodeId: 'loc',
		        fcn: 'requestLC',
		        args: [array[0], array[1],array[2],array[3],array[4],array[5], array[6],array[7],array[8],array[9], array[10],array[11],array[12],array[13],array[14],array[15],array[16]],
		        chainId: channelName,
		        txId: tx_id
		    };
